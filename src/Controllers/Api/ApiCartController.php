    ...
    private function serializeCartResponse(string $message = ''): Response {
        ...
        foreach ($items as $item) {
            $formattedItems[] = [
                ...
                'image' => $this->imageService->getUrl($item->product->image, 'original'),
                'image_thumb' => $this->imageService->getUrl($item->product->image, 'thumb'),
                'image_medium' => $this->imageService->getUrl($item->product->image, 'medium'),
                'image_large' => $this->imageService->getUrl($item->product->image, 'large'),
                'quantity' => $item->qty,
