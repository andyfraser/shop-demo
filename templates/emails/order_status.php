...
<p>Hello,</p>
<p>We're writing to let you know that your order <strong>#<?= $orderId ?></strong> has been updated.</p>
...
<p style="text-align: center; margin: 30px 0;">
    <a href="<?= $baseUrl ?>/account/orders/<?= $orderId ?>" class="btn">View Order Details</a>
</p>
