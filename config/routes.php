...
return [
    ...
    ['method' => 'POST', 'path' => '/admin/categories/delete', 'handler' => [AdminCategoriesController::class, 'delete'], 'middlewares' => $adminPostMiddleware],
    ...
    ['method' => 'POST', 'path' => '/admin/delivery/delete', 'handler' => [AdminDeliveryController::class, 'delete'], 'middlewares' => $adminPostMiddleware],
    ...
    ['method' => 'POST', 'path' => '/admin/attributes/delete', 'handler' => [AdminAttributesController::class, 'delete'], 'middlewares' => $adminPostMiddleware],
    ...
    ['method' => 'POST', 'path' => '/admin/users/delete', 'handler' => [AdminUsersController::class, 'delete'], 'middlewares' => $adminPostMiddleware],
    ...
    ['method' => 'POST', 'path' => '/admin/user-roles/delete', 'handler' => [AdminUserRolesController::class, 'delete'], 'middlewares' => $adminPostMiddleware],
    ...
    ['method' => 'POST', 'path' => '/admin/promotions/delete', 'handler' => [\App\Controllers\AdminPromotionsController::class, 'delete'], 'middlewares' => $adminPostMiddleware],
